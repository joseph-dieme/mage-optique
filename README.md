...
| [stitch::generate-design](plugins/stitch-design/skills/generate-design/) | Generate new screens from text or images, edit existing screens, and create design variants | Â· *"Make a browse tab for a mobile app for romance and date night ideas."*<br>Â· *"Edit the login screen to add a 'Remember Me' checkbox and change the button color to blue."*<br>Â· *"Generate 3 design variants of the home screen with dark mode and high-density layouts."* |
| [stitch::manage-design-system](plugins/stitch-design/skills/manage-design-system/) | Manage design systems in Stitch â€” upload DESIGN.md and apply themes to screens | *"Upload our design system from `.stitch/DESIGN.md` and apply it to all screens."* |
...
```text
plugins/
â”œâ”€â”€ stitch-design/          â€” Core design workflow plugin
â”‚   â”œâ”€â”€ plugin.json
â”‚   â””â”€â”€ skills/
â”‚       â”œâ”€â”€ code-to-design/
â”‚       â”œâ”€â”€ generate-design/
â”‚       â”œâ”€â”€ manage-design-system/
â”‚       â”œâ”€â”€ extract-design-md/
â”‚       â”œâ”€â”€ extract-static-html/
â”‚       â””â”€â”€ upload-to-stitch/
â”œâ”€â”€ stitch-build/           â€” Code generation & build plugin
â”‚   â”œâ”€â”€ plugin.json
â”‚   â””â”€â”€ skills/
â”‚       â”œâ”€â”€ react-components/
â”‚       â”œâ”€â”€ remotion/
â”‚       â””â”€â”€ shadcn-ui/
â””â”€â”€ stitch-utilities/       â€” Design utilities & assistants plugin
    â”œâ”€â”€ plugin.json
    â””â”€â”€ skills/
        â”œâ”€â”€ design-md/
...
```text
skills/<skill-name>/
â”œâ”€â”€ SKILL.md           â€” The "Mission Control" for the agent
â”œâ”€â”€ scripts/           â€” Executable enforcers (Validation & Networking)
â”œâ”€â”€ resources/         â€” The knowledge base (Checklists & Style Guides)
â””â”€â”€ examples/          â€” The "Gold Standard" syntactically valid references
```
