...
- âŒ Using technical jargon without translation (e.g., "rounded-xl" instead of "generously rounded corners")
- âŒ Omitting color codes or using only descriptive names
- âŒ Forgetting to explain functional roles of design elements
- âŒ Being too vague in atmosphere descriptions
- âŒ Ignoring subtle design details like shadows or spacing patterns
