...
3. **Screen metadata fetch**:
   ...
   - Retrieve:
     - `screenshot.downloadUrl` â€” Visual asset for the video
     - `htmlCode.downloadUrl` â€” Optional: for extracting text/content
     - `width`, `height` â€” Screen dimensions for proper scaling
...
1. **`ScreenSlide.tsx`** â€” Individual screen display component
...
2. **`WalkthroughComposition.tsx`** â€” Main video composition
   - Sequences multiple `ScreenSlide` components
   - Handles transitions between screens
   - Adds text overlays and annotations

3. **`config.ts`** â€” Video configuration
...
```
project/
â”œâ”€â”€ video/                      # Remotion project directory
â”‚   â”œâ”€â”€ src/
â”‚   â”‚   â”œâ”€â”€ WalkthroughComposition.tsx
â”‚   â”‚   â”œâ”€â”€ ScreenSlide.tsx
â”‚   â”‚   â”œâ”€â”€ components/
â”‚   â”‚   â”‚   â”œâ”€â”€ Hotspot.tsx
â”‚   â”‚   â”‚   â””â”€â”€ TextOverlay.tsx
â”‚   â”‚   â””â”€â”€ Root.tsx
â”‚   â”œâ”€â”€ public/
â”‚   â”‚   â””â”€â”€ assets/
â”‚   â”‚       â””â”€â”€ screens/        # Downloaded Stitch screenshots
â”‚   â”‚           â”œâ”€â”€ home.png
â”‚   â”‚           â””â”€â”€ history.png
â”‚   â”œâ”€â”€ remotion.config.ts
â”‚   â””â”€â”€ package.json
â”œâ”€â”€ screens.json                # Screen manifest
â””â”€â”€ output.mp4                  # Rendered video
```
...
**Agent workflow:**
1. List Stitch projects â†’ Find "Calculator App" â†’ Extract project ID
2. List screens in project â†’ Identify all screens (Home, History, Settings)
3. Download screenshots for each screen â†’ Save to `assets/screens/`
...
6. Preview in Remotion Studio â†’ Refine timing and transitions
7. Render final video â†’ `calculator-walkthrough.mp4`
